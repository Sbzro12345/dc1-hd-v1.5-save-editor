...
- The plist is located under `/User/Library/Preferences/` in TouchHLE. You will probably need a jailbroken device to access and transfer the plist file. Alternatively, use TouchHLE. The files will be located under the sandbox dir, if using TouchHLE. The plist is located under `com.chillingo.defenderchronicleshd/Library/Preferences/` in TouchHLE. 
